...
for(const {name, path} of inputFiles){
    ...
    const largerPeakListId = timingData.peaksAdi.length >= timingData.peaksArd.length ? 'adi' : 'ard';
    const largerPeakList = largerPeakListId === 'adi' ? timingData.peaksAdi : timingData.peaksArd;
    const smallerPeakList = largerPeakListId === 'adi' ? timingData.peaksArd : timingData.peaksAdi;
    ...
    timingData.unmatchedAdiPeaks = timingData.peaksAdi.length - timingData.peaksArd.length;
