...
bool Plotting = false; /* If you want to plot the data in the Arduino Serial Plotter, set this variable to true. The QRS value
...
bool Saving_Command = false; /* If you do not have an SD Card module or USB Card, you cannot save the data. Also, the Sketch
...
const bool ECG_SIGNAL_TO_SERIAL = true; // "<peak>, <level>, <millis>" instead of "<peak>"
