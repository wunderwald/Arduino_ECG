...
def english(device: str, exteroception: bool) -> Dict[str, Collection[str]]:
...
def danish(device: str, exteroception: bool) -> Dict[str, Collection[str]]:
    """Create the text dictionary with instruction in Danish
...
def french(device: str, exteroception: bool) -> Dict[str, Collection[str]]:
